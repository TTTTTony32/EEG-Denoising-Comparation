...
LastEditors: JinYin
Modified for custom data format: train/test/val_input/output files
'''
...
def load_custom_data(data_path):
    """
    加载自定义格式的数据
    数据格式: train_input.npy, train_output.npy, test_input.npy, test_output.npy, val_input.npy, val_output.npy
    每个文件形状: (3750, 512)
    """
